...
ステージチャンネルは、入っただけでは音声が流れません。
**「ステージを開始」を押してスピーカーになってください。**
聴衆（オーディエンス）のままだと、録音は成功するのに中身が無音になります。
...
| `録音データが空でした` | ステージで**スピーカーになっていない**可能性が高いです。「ステージを開始」を押してください |
